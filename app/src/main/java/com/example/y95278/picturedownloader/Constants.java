...
public final class Constants {
    public static final String UIID = "com.example.picturedownloader.UIID";
    public static final String BROADCAST_PROGRESS = "com.example.picturedownloader.PROGRESS";
